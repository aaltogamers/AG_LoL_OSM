...
const LandingModule = () => {
  ...
  return (
    <div className="bg-teemo-mobile sm:bg-teemo-desktop bg-cover bg-no-repeat bg-center min-h-screen min-w-screen flex flex-col justify-center items-center text-center font-phage text-white tracking-widest px-2">
