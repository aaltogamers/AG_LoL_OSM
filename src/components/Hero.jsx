...
const LandingModule = () => {
  ...
  return (
    <div className="bg-[url('../images/landing.jpg')] bg-cover bg-no-repeat bg-center min-h-screen min-w-screen flex flex-col justify-center items-center text-center font-phage tracking-widest px-2">
