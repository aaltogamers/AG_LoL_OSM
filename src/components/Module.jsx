...
const H2 = ({ children }) => (
  <h2 className="text-3xl md:text-5xl font-outfit-bold mb-8 uppercase">
    {children}
  </h2>
);

const H3 = ({ children }) => (
  <h2 className="text-xl md:text-2xl font-outfit-bold mb-2">{children}</h2>
);
...
const A = ({ children, href }) => (
  <Link
    className="text-link hover:cursor-pointer hover:text-link-hover"
    to={href}
  >
    {children}
  </Link>
...
const UL = ({ children }) => <ul className="list-inside ml-4">{children}</ul>;
